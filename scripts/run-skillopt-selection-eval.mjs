...
const splitDir = path.join(root, 'runs/009-skillopt-official-searchqa-smoke/searchqa_selection_split');
...
const configPath = path.join(root, 'configs/searchqa/selection.yaml');
...
function proofPayload(status, extra = {}) {
  return {
    proof_id: `skillopt-selection-${status}`,
    checked_at: new Date().toISOString(),
    runner: 'scripts/run-skillopt-selection-eval.mjs',
    status,
    ...payload,
