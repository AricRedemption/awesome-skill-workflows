...
- Generic action-verification states belong in Layer 1 contracts, while
  scenario-local terms such as `draft_verified` or `compliant_publish_verified`
  stay derived summaries owned by the relevant scenario.
