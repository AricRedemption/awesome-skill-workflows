  ...
  return (
    <section id="skillopt" className="mx-auto w-full max-w-[1240px] px-4 py-12">
      <div className="mb-7 border-b border-[#d1bf94]/12 pb-7">
        <h2 className="asw-display-serif max-w-[780px] text-[clamp(1.9rem,3.5vw,3rem)] leading-[1.02] text-[#f8f3e8]">
          {paperReproduction.title}
        </h2>
        <p className="mt-3 max-w-[560px] text-[0.98rem] leading-[1.7] text-[#ebe1c8]/66">{paperReproduction.description}</p>
      </div>

      <article className="overflow-hidden rounded-[28px] border border-[#d1bf94]/15 bg-[linear-gradient(180deg,rgba(25,30,29,0.98),rgba(10,13,13,0.98))] shadow-[0_0_0_1px_rgba(122,170,119,0.12),0_30px_90px_rgba(0,0,0,0.34)]">
          ...
          <div className="p-6 max-[700px]:p-4">
            <div className="grid gap-3">
              {paperReproduction.steps.map((step, index) => (
                <div className="rounded-[18px] border border-[#d1bf94]/10 bg-[#111511]/82 p-4" key={step.title}>
                  ...
                  <p className="mt-3 text-sm leading-[1.64] text-[#ebe1c8]/68">{step.body}</p>
                </div>
              ))}
            </div>
