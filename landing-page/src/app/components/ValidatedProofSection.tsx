...
export function ValidatedProofSection() {
  return (
    <section id="validated" className="mx-auto w-full max-w-[1240px] px-4 py-12">
      ...
      <article className="overflow-hidden rounded-[30px] border border-[#d1bf94]/18 bg-[linear-gradient(180deg,rgba(27,34,26,0.98),rgba(12,15,12,0.98))] p-6 shadow-[0_0_0_1px_rgba(122,170,119,0.14),0_36px_120px_rgba(0,0,0,0.42)]">
