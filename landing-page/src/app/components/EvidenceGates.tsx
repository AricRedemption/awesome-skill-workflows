import { gates } from "../content";

export function EvidenceGates() {
  return (
    <section id="evidence" className="mx-auto w-full max-w-[1240px] px-4 py-12">
      <div className="mx-auto mb-6 max-w-[780px] text-center">
        ...
        <h2 className="text-[clamp(1.65rem,3.2vw,2.75rem)] font-bold leading-[1.08] text-[#f8f3e8]">{gates.title}</h2>
        <p className="mt-4 text-base leading-[1.72] text-[#ebe1c8]/75">{gates.description}</p>
      </div>
      <figure className="mx-auto mb-4 w-[min(980px,100%)] overflow-hidden rounded-[22px] border border-[#d1bf94]/16 bg-[#0b1018] p-3 shadow-[0_0_0_1px_rgba(122,170,119,0.10),0_24px_80px_rgba(0,0,0,0.28)]">
        <img className="block h-auto w-full rounded-[16px]" src={gates.visual.src} alt={gates.visual.alt} />
      </figure>
    </section>
  );
}
