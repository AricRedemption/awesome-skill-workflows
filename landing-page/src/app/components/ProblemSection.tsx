  ...
  return (
    <section id="problem" className="mx-auto w-full max-w-[1240px] px-4 py-12">
      <div className="mx-auto mb-6 max-w-[780px] text-center">
        ...
        <h2 className="text-[clamp(1.65rem,3.2vw,2.75rem)] font-bold leading-[1.08] text-[#f8f3e8]">{problem.title}</h2>
      ...
      <div className="grid grid-cols-3 gap-3.5 max-[900px]:grid-cols-1">
        {problem.cards.map((card) => (
          <article
            ...
            key={card.title}
          >
            <h3 className="max-w-[260px] text-[1.25rem] font-bold leading-tight text-[#f8f3e8]">{card.title}</h3>
